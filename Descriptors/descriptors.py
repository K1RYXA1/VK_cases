...
# Нужно сделать три дескриптора для какой-то области интереса (наука, финансы, хобби и тд), но если совсем не получается, то можно использовать шаблона ниже в качестве основы. У дескрипторов должен быть базовый класс с проверкой, которую наследующие классы должны будут реализовать.
